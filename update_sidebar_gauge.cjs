...
const bannerRe = `             <span className="text-[10px] text-blue-500 font-bold tracking-wider mt-1 flex items-center">
               <span className="w-1.5 h-1.5 bg-green-500 rounded-full mr-1.5 animate-pulse"></span>
               多AGENT集群就绪
             </span>`;

const bannerRep = `             <span className="text-[10px] text-blue-500 font-bold tracking-wider mt-1 flex items-center">
               <span className="w-1.5 h-1.5 bg-green-500 rounded-full mr-1.5 animate-pulse"></span>
               多AGENT集群就绪
             </span>
           </div>
...
sidebar = sidebar.replace(bannerRe, bannerRep);

...
export const productFeatureRegistry: ProductFeatureRecord[] = [
  ...domain(1, '我的 Agent 看板', [
    ...
    { id: 'workflow', label: 'Agent 集群状态', icon: 'Network', componentKey: 'AgentWorkflowView' },
    { id: 'tasks', label: '全局任务调度', icon: 'ListTodo', componentKey: 'TasksView' },
    { id: 'agent_status', label: 'Agent 状态监测', icon: 'HeartPulse', componentKey: 'AgentStatusDashboardView' },
  ]),
  ...domain(2, '主理人：电商操盘', [
    { id: 'e_main_image', label: '主图设计', icon: 'LayoutTemplate', componentKey: 'ECommerceView:e_main_image' },
    { id: 'e_video', label: '商品视频', icon: 'MonitorPlay', componentKey: 'ECommerceView:e_video' },
    { id: 'e_detail_page', label: '详情页设计助理', icon: 'PanelTop', componentKey: 'ECommerceView:e_detail_page' },
    { id: 'e_poster', label: '创意海报', icon: 'Palette', componentKey: 'ECommerceView:e_poster' },
    { id: 'ai_image_edit', label: 'AI图像编辑', icon: 'Sparkles', componentKey: 'ImageEditorView' },
    { id: 'e_clone', label: '克隆设计', icon: 'Copy', componentKey: 'ECommerceView:e_clone' },
  ]),
  ...domain(3, '主理人：无界创作', [
    { id: 'video', label: '视频创作引擎', icon: 'Film', componentKey: 'VideoCreationView' },
    { id: 'image', label: '商用级图像生成', icon: 'ImageIcon', componentKey: 'ImageCreationView' },
    { id: 'ai_canvas', label: '无限模态 AI 画布', icon: 'Palette', componentKey: 'AICanvasView' },
    { id: 'chat', label: '全能顾问对话', icon: 'MessageSquare', componentKey: 'ChatView' },
    { id: 'speech', label: '多语种语音引擎', icon: 'Mic', componentKey: 'SpeechView' },
  ]),
  ...domain(4, '主理人：文案营销', [
    { id: 'copywriting_create', label: '文案创作', icon: 'PenTool', componentKey: 'CopywritingView:create' },
    { id: 'copywriting_tools', label: '创作工具', icon: 'Wrench', componentKey: 'CopywritingView:tools' },
    { id: 'copywriting_keywords', label: '关键词库', icon: 'BookType', componentKey: 'CopywritingView:keywords' },
  ]),
  ...domain(5, '主理人：视频工业', [
    { id: 'remix_home', label: '混剪首页', icon: 'Home', componentKey: 'RemixView:home' },
    { id: 'remix_smart', label: '智能混剪', icon: 'Wand2', componentKey: 'RemixView:smart' },
    { id: 'remix_viral', label: '爆款视频复刻', icon: 'Sparkles', componentKey: 'RemixView:viral' },
    { id: 'remix_materials', label: '混剪素材', icon: 'Layers', componentKey: 'RemixView:materials' },
    { id: 'remix_titles', label: '标题模板', icon: 'Type', componentKey: 'RemixView:titles' },
    { id: 'remix_templates', label: '视频模板', icon: 'LayoutTemplate', componentKey: 'RemixView:templates' },
  ]),
  ...domain(6, '主理人：分身直播', [
  ...
  ...domain(7, '主理人：私域与客户', [
    { id: 'crm', label: '智能客户管家 (CRM)', icon: 'UsersRound', componentKey: 'CrmView' },
    { id: 'customer_service', label: '全天候 AI 客服', icon: 'Headphones', componentKey: 'CustomerServiceView' },
  ]),
  ...domain(8, '大航海：全域裂变', [
    { id: 'marketing_viral', label: '爆店码', icon: 'ScanLine', componentKey: 'MarketingView:viral' },
    { id: 'marketing_nfc', label: '碰一碰', icon: 'SmartphoneNfc', componentKey: 'MarketingView:nfc' },
    { id: 'marketing_website', label: '智能官网', icon: 'Globe', componentKey: 'MarketingView:website' },
  ]),
  ...domain(9, '导演台与分镜流', [
    { id: 'director_desk', label: '全局导演台', icon: 'Video', componentKey: 'DirectorDeskView' },
  ]),
  ...domain(10, '主理人：包揽设计', [
    { id: 'design_logo', label: '智能 LOGO', icon: 'Palette', componentKey: 'DesignWorkflowView:logo' },
    { id: 'design_packaging', label: 'AI 包装设计', icon: 'Package', componentKey: 'DesignWorkflowView:packaging' },
    { id: 'design_ads', label: '广告创意', icon: 'Megaphone', componentKey: 'DesignWorkflowView:ads' },
    { id: 'design_interior', label: 'AI 家装设计', icon: 'Home', componentKey: 'DesignWorkflowView:interior' },
    { id: 'design_fashion', label: 'AI 服装设计', icon: 'Shirt', componentKey: 'DesignWorkflowView:fashion' },
  ]),
  ...domain(11, '我的数字资产库', [
    { id: 'data', label: '业务数据罗盘', icon: 'BarChart2', componentKey: 'DataAnalyticsView' },
    { id: 'assets', label: '数字资产保险库', icon: 'Folder', componentKey: 'AssetsView' },
    { id: 'projects', label: '品牌知识库', icon: 'Briefcase', componentKey: 'ProjectsView' },
  ]),
  ...domain(12, '虚拟数字员工', [
    { id: 'team', label: '数字员工概览', icon: 'Building2', componentKey: 'TeamView:overview' },
    { id: 'sub_accounts', label: '分发矩阵账号', icon: 'Users', componentKey: 'SubAccountsView' },
    { id: 'team_write', label: '人机推演协作', icon: 'PenTool', componentKey: 'TeamView:write' },
    { id: 'team_tasks', label: '异步协同任务', icon: 'ListTodo', componentKey: 'TeamView:tasks' },
    { id: 'team_assets', label: '共享给Agent的库', icon: 'Folder', componentKey: 'TeamView:assets' },
    { id: 'team_more', label: '主理人审批流', icon: 'Layers', componentKey: 'TeamView:more' },
  ]),
  ...domain(13, '云连锁与小店群', [
    { id: 'store_dashboard', label: '多店全盘看板', icon: 'LayoutDashboard', componentKey: 'StoreDashboardView' },
    { id: 'store_list', label: '门店官网与分店', icon: 'Store', componentKey: 'StoreListView' },
    { id: 'store_orders', label: '统一订单管理', icon: 'ShoppingBag', componentKey: 'StoreOrdersView' },
    { id: 'store_inventory', label: '智能调拨与库存', icon: 'Package', componentKey: 'StoreInventoryView' },
    { id: 'store_design', label: '门店网页设计', icon: 'LayoutTemplate', componentKey: 'StoreDesignView' },
    { id: 'store_staff', label: '虚拟导购与巡店', icon: 'UsersRound', componentKey: 'StoreStaffView' },
    { id: 'store_marketing', label: '自动营销策略', icon: 'Megaphone', componentKey: 'StoreMarketingView' },
    { id: 'store_distribution', label: '分销代理网络', icon: 'Split', componentKey: 'StoreDistributionView' },
    { id: 'store_events', label: '活动与引流', icon: 'Gift', componentKey: 'StoreEventsView' },
    { id: 'store_miniapp', label: '小程序端管理', icon: 'Smartphone', componentKey: 'StoreMiniappView' },
  ]),
  ...domain(14, '系统引擎与权限', [
    { id: 'media', label: '社媒矩阵挂载', icon: 'Share2', componentKey: 'MediaAccountsView' },
    { id: 'employee_accounts', label: '兼职员工账号池', icon: 'UserCircle2', componentKey: 'EmployeeAccountsView' },
    { id: 'billing', label: '算力与 Token 监控', icon: 'CreditCard', componentKey: 'BillingView' },
    { id: 'saas_api_keys', label: 'API 密钥与开发者', icon: 'Key', componentKey: 'ApiKeysView' },
    { id: 'settings', label: '全局偏好配置', icon: 'Settings', readiness: 'implemented', componentKey: 'SettingsView' },
    { id: 'admin', label: '系统管理', icon: 'Shield', componentKey: 'AdminView' },
    { id: 'finance', label: '财务与票据管理', icon: 'Wallet', componentKey: 'FinanceView' },
    { id: 'tax', label: '税务筹划与计算', icon: 'Calculator', componentKey: 'TaxView' },
    { id: 'activity_logs', label: '全站操作审计日志', icon: 'Activity', componentKey: 'ActivityLogsView' },
  ]),
  ...domain(15, '隐藏与内部路由', [
    {
      id: 'e_white_bg',
